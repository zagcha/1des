...
.label-primary, .btn-primary {
    background-color: #bf3644!important;
}
...
.fl.fa.fa-sign-in.btn.btn-primary.dots.roomh.border.corner, span.corner.fa.fa-user.label.label-primary.fr.uc, label.nosel.ninr.fl.uzr.label.label-primary, label.nosel.inr.fl.uzr.label.label-primary, .fl.fa.fa-sign-in.btn.btn-primary.dots.roomh.border.corner {
...
div#tlogins ::-webkit-scrollbar-thumb {
    ...
    border: 71px #fff;
    border-radius: 31px;
    background: linear-gradient(163deg,#bf3644 0%,#bf3644 100%)
}
